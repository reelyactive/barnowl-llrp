...
function prepareRaddec(message, reader) {
  ...
  if(message.hasOwnProperty('TagReportData')) {
    ...
    if(message.TagReportData.hasOwnProperty('PeakRSSI')) {
      decoding.rssi = message.TagReportData.PeakRSSI;
    }
    if(message.TagReportData.hasOwnProperty('AntennaID')) {
      decoding.receiverAntenna = message.TagReportData.AntennaID;
    }
  }
  ...
  if(transmitterId) {
    ...
    if(reader) {
      decoding.receiverId = reader.receiverId;
      decoding.receiverIdType = reader.receiverIdType;
      raddec.addDecoding(decoding);
    }
  }
